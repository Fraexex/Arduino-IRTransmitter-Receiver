...
void setup() {
  ...
  OCR2A = (F_CPU / 100000000 / 1000000) * PULSE_DURATION - 1; // Set Timer2 compare value for pulse duration
...
ISR(TIMER2_COMPA_vect) {
  if (transmitting) {
    if (pulseActive) {
      ...
      pulseActive = false;
      OCR2A = (F_CPU / 100000000 / 1000000) * SPACE_DURATION - 1; // Set Timer2 compare value for space duration
    } else {
      // End of space
      if (bitCount < 8) {
